...
export class ResourceManager {
    private readonly _samplers: Map<EN_SAMPLER_TYPE, Sampler> = new Map();
    private readonly _textures: Map<EN_DATA_TEXTURE_TYPE, WGPUTexture> = new Map();
    ...
    public getSampler(type: EN_SAMPLER_TYPE) {
        return this._samplers.get(type);
    }

    public getTexture(type: EN_DATA_TEXTURE_TYPE) {
    ...
    private _createDummyTextures() {
        ...
        this._textures.set(EN_DATA_TEXTURE_TYPE.BLACK, this._graphicsDevice.createTexture(descBlack, [{
        ...
        this._textures.set(EN_DATA_TEXTURE_TYPE.METAL_ROUGHNESS, this._graphicsDevice.createTexture(descMetalRoughness, [{
        ...
        this._textures.set(EN_DATA_TEXTURE_TYPE.WHITE, this._graphicsDevice.createTexture(descWhite, [{
        ...
        this._textures.set(EN_DATA_TEXTURE_TYPE.WHITE_CUBE, this._graphicsDevice.createTexture(descWhiteCube, [{
        ...
        this._textures.set(EN_DATA_TEXTURE_TYPE.DEPTH, this._graphicsDevice.createTexture(descDepth, [{
